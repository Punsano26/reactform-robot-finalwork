...
const RegistrationForm = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    firstnameEng: Yup.string().required("Required")
    ...
    idCard: Yup.string()
      .required("Required")
      .min(13, "ใส่ให้ครบ 13 หลักสิ")
      .max(13, "ใส่ให้ครบ 13 หลักสิ"),
    password: Yup.string()
      .required("Required")
      .min(8, "ใส่ให้มันครบ 8 ตัวสิ"),
    mobile: Yup.string()
      .required("Required")
      .min(10, "ใส่เบอร์ให้ครบ 10 ตัวสิ")
      .max(10, "ใส่เบอร์ให้ครบ 10 ตัวสิ"),
    email: Yup.string()
